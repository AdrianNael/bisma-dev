...
const PositionManagement = (_props: Props) => {
  ...
  const confirmDeletion = async (positionId: number) => {
  ...
  const handleDelete = async (positionId: number) => {
    try {
      const response = await axiosJWT.delete(
        `${APIEndpoint}/api/positions/${positionId}`,
      );
  ...
  return (
    <Layout title="Manage Users - Position">
      <div className="flex justify-center m-4 mt-6">
        <div className="flex flex-col gap-6 w-full">
          <div className="flex justify-between gap-4">
            <Link
              href={"/admin/manageuser/position/new"}
...
export default withPage(PositionManagement);

...
const EditPosition = () => {
  ...
  const fetchPositionData = async () => {
    try {
      const response = await axiosJWT.get(`${APIEndpoint}/api/positions/${id}`);
  ...
  return (
    <Layout title="Edit Posisi">
      <div className="w-full min-h-[calc(100vh-2rem)] p-6">
        <h2 className="text-2xl font-bold mb-6">Edit Posisi</h2>
        <form
...
export default withPage(EditPosition);
